...
//}
//
//BoundingBox Mesh::computeFaceBbox(int f)
//{
//    MeshVertex& v0 = vertices[faces[f].vertex_index[0]];
//    MeshVertex& v1 = vertices[faces[f].vertex_index[1]];
//    MeshVertex& v2 = vertices[faces[f].vertex_index[2]];
//
//
